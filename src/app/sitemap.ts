...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes: Array<{ url: string; lastModified?: string; changeFrequency?: MetadataRoute.Sitemap[0]["changeFrequency"]; priority?: number }>
    = [
      ...
      { url: `${siteUrl}/blog/rag-on-nextjs`, lastModified: ragMeta.date, changeFrequency: "monthly", priority: 0.7 },
      { url: `${siteUrl}/blog/loading-states-design`, lastModified: loadingMeta.date, changeFrequency: "monthly", priority: 0.7 },
    ];
